...
- 고객 모바일 소스와 문서: `mobile/` — 2026-09-13 r43, 고객 대표 소모품 선택·Reset 및 리튬 SOC 숫자 색상 포함.
- 고객 전달용 HTML ZIP: [다운로드](mobile/downloads/MACHINE_IQ_MOBILE_HTML_20260913.zip). 압축 해제 후 `시작.html`을 엽니다.
