...
- 고객 모바일 소스와 문서: `mobile/` — 2026-09-13 r46, 리튬 온도·충전·배터리 상태 및 스마트 충전 설정, 민감·주의·경고별 충격 건수, 에러 PDF 유무별 다운로드. 기존 대표 전용 소모품 Reset 및 리튬/납산 배터리 아이콘 구간색 유지.
- 고객 전달용 HTML ZIP: [다운로드](mobile/downloads/MACHINE_IQ_MOBILE_HTML_20260913_r46.zip). 압축 해제 후 `시작.html`을 엽니다. 충전 설정은 시연 저장이며 실제 장비 명령은 없습니다.
